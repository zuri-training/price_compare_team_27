# Generated by Django 4.0.6 on 2022-07-29 03:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_jumia', models.PositiveIntegerField(blank=True, null=True)),
                ('price_komga', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='price_compare_app.phone')),
